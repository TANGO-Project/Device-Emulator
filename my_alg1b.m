...
%like my_alg1.m but when only single cores are used, I compute the emulations again

function  [output,emulations,makespan,slr,em,util,less_em] = my_alg1b (A,D,HW,cpu_ref, THRES, THRESHOLD,test)
